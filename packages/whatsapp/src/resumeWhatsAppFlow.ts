...
type Props = {
  ...
  callFrom?: "webhook";
  // AJOUT : Body complet du webhook Meta
  fullWebhookBody?: any;
  parsedEntries?: any[];
};
...
const extractMediaId = (message: WhatsAppIncomingMessage | undefined): string | null => {
...
const extractMessageText = (message: WhatsAppIncomingMessage | undefined): string | null => {
  if (!message) return null;
  switch (message.type) {
    ...
    case 'interactive':
      switch (message.interactive.type) {
        case 'button_reply': return message.interactive.button_reply.title;
        case 'list_reply': return message.interactive.list_reply.title;
        default: return null;
      }
    default: return null;
  }
        ...
        ? {
            ...
            whatsApp: {
              ...
              referral: referral
                ...
                : undefined,
              metaBody: JSON.stringify({ DEBUG_fullWebhookBody: fullWebhookBody,
                ...fullWebhookBody,
                workspaceId: workspaceId,
                credentialsId: credentialsId,
                timestamp: new Date().toISOString(),
                originalMessages: receivedMessages,

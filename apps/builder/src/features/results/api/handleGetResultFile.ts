...
export const getResultFileInputSchema = z.object({
  typebotId: z.string(),
  resultId: z.string(),
  fileName: z.string(),
});

export const handleGetResultFile = async ({
  input: { typebotId, resultId, fileName },
  context: { user },
}: {
  input: z.infer<typeof getResultFileInputSchema>;
